...
public class MenuFeaturedAdapter extends RecyclerView.Adapter<MenuFeaturedAdapter.HorizontalViewHolder> {

    private Context context;

    private List<Item> featuredItemList;

    private String featuredMenuImagePath;


    public MenuFeaturedAdapter(Context context, List<Item> featuredItemList, String featuredMenuImagePath) {
        this.context = context;
        this.featuredItemList = featuredItemList;
        this.featuredMenuImagePath = featuredMenuImagePath;
    }
    ...
    public void onBindViewHolder(final HorizontalViewHolder holder, final int position) {
        ...
        try {
            ...
            String image_url = featuredMenuImagePath + featuredItemList.get(position).getItemImage();
            ...
            holder.tv_category.setText(featuredItemList.get(position).getItemName());
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    bundle.putString("item_id", featuredItemList.get(position).getItemId());
                    bundle.putString("item_name", featuredItemList.get(position).getItemName());

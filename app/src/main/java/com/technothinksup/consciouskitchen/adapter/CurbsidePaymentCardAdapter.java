...
public class CurbsidePaymentCardAdapter extends RecyclerView.Adapter<CurbsidePaymentCardAdapter.HorizontalViewHolder> {
    ...
    public CurbsidePaymentCardAdapter(Context context, List<PaymentCard> paymentCardList) {

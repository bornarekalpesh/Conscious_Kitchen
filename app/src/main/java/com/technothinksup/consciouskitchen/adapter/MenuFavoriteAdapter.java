...
public class MenuFavoriteAdapter extends RecyclerView.Adapter<MenuFavoriteAdapter.HorizontalViewHolder> {

    private Context context;

    private List<Item> favoriteItemList;

    private String favoriteItemImagePath;

    public MenuFavoriteAdapter(Context context, List<Item> favoriteItemList, String favoriteItemImagePath) {
        this.context = context;
        this.favoriteItemList = favoriteItemList;
        this.favoriteItemImagePath = favoriteItemImagePath;
    }
    ...
    public void onBindViewHolder(final HorizontalViewHolder holder, final int position) {
        ...
        try {
            ...
            String image_url = favoriteItemImagePath + favoriteItemList.get(position).getItemImage();
            ...
            holder.tv_category.setText(favoriteItemList.get(position).getItemName());
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    bundle.putString("item_id", favoriteItemList.get(position).getItemId());
                    bundle.putString("item_name", favoriteItemList.get(position).getItemName());

...
public class UpcomingEventAdapter extends RecyclerView.Adapter<UpcomingEventAdapter.HorizontalViewHolder> {
    ...
    public UpcomingEventAdapter(Context context, List<EventList> eventLists, String eventImagePath) {
    ...
    public HorizontalViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.upcoming_item_layout_recycler, parent, false);
    ...
    public class HorizontalViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView textView_EventAdapterTitle,textView_EventAdapterDate;
